...
class Game:
    ...
    def main_menu(self):
        ...
        while run:
            ...
            prev_character_button = Button(image=pygame.image.load("graphics/Button Rect.png"), pos=(150, 150),
                                text_input=">", font=self.get_font(20), base_color="Black", hovering_color="#baf4fc")
            next_character_button = Button(image=pygame.image.load("graphics/Button Rect.png"), pos=(650, 150),
                                text_input=">", font=self.get_font(20), base_color="Black", hovering_color="#baf4fc")
...
new_bg_surface = pygame.image.load('graphics/player/fly_3.png').convert_alpha()
